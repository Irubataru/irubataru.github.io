...
The existence of <Code code={`Set`} lang="vb" inline /> is documented in
[Microsoft's guidelines for converting VBA code to .Net][set-documentation], and
